...
## Codebase Intelligence for text_to_video_project (Repowise)

Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-02 (commit 5525661). Confidence: 100%.
...
### Architecture
**Files:** 3 | **Lines:** 1111
text_to_video_project is a html codebase of 3 files. Execution starts at text_to_video/app.py. Start here when reading the codebase. Ranked by PageRank over the import graph: the files most of the codebase ultimately depends on.

### Key modules
- `text_to_video` — text_to_video
**Language:** python | **Files:** 1 | **Public symbols:** 38 / 41
Covers the 1 source files in text_to_video

### Entry points
- `text_to_video/app.py`

### Code health
Three co-equal signals: defect risk 7.35/10 avg, hotspot health 7.35/10 (stable), worst `text_to_video/app.py` at 5.5/10 · maintainability 6.46/10 · performance risk 6 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
